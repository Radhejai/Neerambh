  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-purple-900/20 via-royal-900 to-royal-950 p-8 md:p-12 backdrop-blur-xl purple-glow">
        ...
        <h1 className="mt-2 font-serif text-2xl md:text-3xl font-extrabold text-white max-w-2xl">
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h2 className="text-sm font-semibold text-white">Precision First</h2>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h2 className="text-sm font-semibold text-white">Founder-Focused</h2>
              <p className="mt-1 text-xs text-royal-400 font-light leading-relaxed">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h2 className="text-sm font-semibold text-white">End-to-End</h2>
              <p className="mt-1 text-xs text-royal-400 font-light leading-relaxed">

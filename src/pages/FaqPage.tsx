...
/**
 * Aggregates every service's FAQ list (src/data.ts) onto one page, grouped
 * by service. Uses native <details>/<summary> so all questions and answers
 * are present in the DOM (and crawlable / prerenderable) even collapsed —
 * no JS required for content to be indexable.
 */
  ...
  return (
    <div className="space-y-10">
      <p className="text-sm text-royal-300 font-light leading-relaxed max-w-2xl">
        Answers to the questions we hear most often, organised by service. Can&apos;t find what
        you&apos;re looking for?{' '}
